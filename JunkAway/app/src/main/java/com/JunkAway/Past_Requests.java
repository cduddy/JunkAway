...
public class Past_Requests extends AppCompatActivity {
    // Progress Dialog
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                // Starting new intent
                Intent in = new Intent(Past_Requests.this,
                        ViewRequest.class);
    ...
    {
        ProgressDialog pdLoading = new ProgressDialog(Past_Requests.this);
        ...
        protected String doInBackground(String... params) {
            try{
                ...
                url = new URL("https://people.eecs.ku.edu/~cduddy/JunkAway/PastRequests.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("")){
                ...
                Toast.makeText(Past_Requests.this, "Oops! Something went wrong. Connection Problem.", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(Past_Requests.this,NormalUser_HomeScreen.class);
                startActivity(intent);
                Past_Requests.this.finish();
            }else
            {
