...
public class Current_Jobs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                // Starting new intent
                Intent in = new Intent(Current_Jobs.this,
                        ViewRequest.class);
    ...
    {
        ProgressDialog pdLoading = new ProgressDialog(Current_Jobs.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("")){
                ...
                Toast.makeText(Current_Jobs.this, "Oops! Something went wrong. Connection Problem.", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(Current_Jobs.this,NormalUser_HomeScreen.class);
                startActivity(intent);
                Current_Jobs.this.finish();
            }else
            {
                ...
                Toast.makeText(Current_Jobs.this, "Retrieved Assigned Jobs", Toast.LENGTH_LONG).show();
