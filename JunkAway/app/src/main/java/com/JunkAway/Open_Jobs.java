...
public class Open_Jobs extends AppCompatActivity {
    // Progress Dialog
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                // Starting new intent
                Intent in = new Intent(Open_Jobs.this,
                        ViewRequest.class);
    ...
    {
        ProgressDialog pdLoading = new ProgressDialog(Open_Jobs.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("")){
                ...
                Toast.makeText(Open_Jobs.this, "Oops! Something went wrong. Connection Problem.", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(Open_Jobs.this,NormalUser_HomeScreen.class);
                startActivity(intent);
                Open_Jobs.this.finish();
            }else
            {
